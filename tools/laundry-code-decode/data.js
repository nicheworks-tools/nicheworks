window.SYMBOLS = [
  ...
  { id:"wash_95", cat:"wash", m:{temp:95},
    ja:{summary:"95℃以下で洗濯可", detail:"高温洗いが可能です。色移り等に注意してください。"},
    en:{summary:"Wash at 95°C", detail:"Hot wash allowed. Watch for color bleed."}
  },
  ...
  { id:"wash_hand", cat:"wash", m:{hand:true},
  ...
  { id:"tumble_low", cat:"dry", m:{tumble:true, dots:1},
    ja:{summary:"乾燥機 低温", detail:"低温設定でタンブル乾燥してください。"},
    en:{summary:"Tumble dry low", detail:"Tumble dry on low heat."}
  },
  ...
  { id:"dry_flat", cat:"dry", m:{flat:true},
    ja:{summary:"平干し", detail:"平らな場所で形を整えて干してください。"},
    en:{summary:"Dry flat", detail:"Lay flat to dry after reshaping."}
  },
  { id:"dry_shade_line", cat:"dry", m:{line:true, shade:true},
    ja:{summary:"日陰でつり干し", detail:"直射日光を避け、日陰でつり干ししてください。"},
    en:{summary:"Line dry in shade", detail:"Hang to dry in the shade."}
  },
  { id:"dry_shade_flat", cat:"dry", m:{flat:true, shade:true},
  ...
  { id:"iron_low", cat:"iron", m:{dots:1},
    ja:{summary:"低温アイロン", detail:"110℃以下が目安です。"},
    en:{summary:"Low heat iron", detail:"Low temperature (max ~110°C)."}
  },
  { id:"iron_med", cat:"iron", m:{dots:2},
    ja:{summary:"中温アイロン", detail:"150℃以下が目安です。"},
    en:{summary:"Medium heat iron", detail:"Medium temperature (max ~150°C)."}
  },
  { id:"iron_high", cat:"iron", m:{dots:3},
    ja:{summary:"高温アイロン", detail:"200℃以下が目安です。素材によっては当て布推奨。"},
    en:{summary:"High heat iron", detail:"High temperature (max ~200°C). Use a pressing cloth if needed."}
  },
  { id:"iron_no", cat:"iron", m:{no:true},
    ja:{summary:"アイロン不可", detail:"アイロンがけできません。熱で変形する恐れがあります。"},
    en:{summary:"Do not iron", detail:"Do not iron. Heat may damage the fabric."}
  },
  { id:"iron_no_steam", cat:"iron", m:{dots:2, steamNo:true},
    ja:{summary:"スチーム不可（中温）", detail:"スチームは使わず、乾いたアイロンで中温。"},
    en:{summary:"No steam (medium)", detail:"Do not use steam. Dry iron on medium heat."}
  },
