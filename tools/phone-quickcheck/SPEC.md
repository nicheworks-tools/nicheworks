...
- Current dataset: `191 verified models`
...
The maintained public dataset contains 191 verified models across Apple, Google, Samsung, Sony, SHARP, OPPO, Xiaomi, Motorola, and ZTE, including 32 foldables with separate folded/unfolded dimensions. Users can search by model name and maintained aliases, filter by manufacturer, charging connector, and release year, and sort by newest, lightest, or compact-size oriented order.
...
- [x] The maintained public dataset contains 191 maintained models.
