...
const TYPE_MAP = new Map([
  ...
  ['粗大ごみ', 'bulky_waste'], ['検索ページ', 'waste_search']
]);
...
<section class="municipality-related"><h2 data-i18n="ja">東京都の関連ページ</h2><h2 data-i18n="en">Related Tokyo pages</h2><div class="municipality-related-links">${related}</div><p><a href="/tools/trashnavi/"><span data-i18n="ja">← TrashNaviでほかの自治体を探す</span><span data-i18n="en">← Search other municipalities in TrashNavi</span></a></p></section>
