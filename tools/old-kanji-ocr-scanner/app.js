const i18n = {
  ja: {
    ...
    ocrLangNote: '日本語OCRを使用します。旧字体・異体字・縦書き・かすれた文字は誤認識される場合があります。',
  ...
  en: {
    ...
    ocrLangNote: 'Japanese OCR is used. Old or variant kanji, vertical text, and faded text may be misread.',
