...
assert.equal(
  ...
  PRIOR_VERIFIED_NOTE_COUNT + Object.keys(EXPECTED_WAVE18).length,
  'wave 18 must extend the 70 reviewed note identities by exactly four source-backed identities'
);
