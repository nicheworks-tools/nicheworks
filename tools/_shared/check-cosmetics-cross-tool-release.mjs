...
check(liteApp.includes("binder: { ja: '結合剤', en: 'Binder' }"), 'Lite must expose the reviewed bilingual binder role');
check(liteApp.includes("binder: { ja: '粉末状の成分同士をまとめ、製品のまとまりを保つ目的で使われる成分です。', en: 'Used to bind powder ingredients together and help maintain product cohesion.' }"), 'Lite binder role explanation must remain bilingual and source-aligned');
...
check(resultUi.includes('binder: { ja: "結合剤", en: "Binder" }'), 'FastScan must expose the reviewed bilingual binder role');
check(resultUi.includes('binder: { ja: "粉末状の成分同士をまとめ、製品のまとまりを保つ目的で使われる成分です。", en: "Used to bind powder ingredients together and help maintain product cohesion." }'), 'FastScan binder role explanation must remain bilingual and source-aligned');
