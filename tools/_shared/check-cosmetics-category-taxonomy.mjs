...
assert.equal(authorityFunctionToCategory.size, 16, 'authority function vocabulary must contain exactly 16 reviewed terms');
...
console.log(JSON.stringify({
  status: 'pass',
  phase: 'verified-category-taxonomy-wave-12',
