...
const EXPECTED_CATEGORIES = new Set([
  ...
  'skin conditioning', 'emollient', 'cleanser', 'emulsifier', 'smoothing', 'binder', 'film former', 'hair conditioning', 'fragrance'
]);
...
const ALLOWED_SOURCE_HOSTS = new Set(['www.cosmeticsinfo.org', 'health.ec.europa.eu', 'cosmileeurope.eu', 'kcia.or.kr']);
...
assert.equal(authorityFunctionToCategory.size, 24, 'authority function vocabulary must contain exactly 24 reviewed terms');
