...
assert.equal(
  ...
  PRIOR_VERIFIED_NOTE_COUNT + Object.keys(EXPECTED_WAVE16).length,
  'wave 16 must extend the 62 reviewed note identities by exactly four source-backed identities'
);
