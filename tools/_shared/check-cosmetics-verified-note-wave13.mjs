...
assert.equal(
  ...
  PRIOR_VERIFIED_NOTE_COUNT + Object.keys(EXPECTED_WAVE13).length,
  'wave 13 must extend the 50 reviewed note identities by exactly four source-backed identities'
);
