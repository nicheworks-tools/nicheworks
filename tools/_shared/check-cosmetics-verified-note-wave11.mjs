...
assert.ok(
  Object.keys(evidence).length >= PRIOR_VERIFIED_NOTE_COUNT + Object.keys(EXPECTED_WAVE11).length,
  'wave 11 reviewed identities must remain present as later verified-note waves extend the overlay'
);
