...
assert.equal(
  ...
  PRIOR_VERIFIED_NOTE_COUNT + Object.keys(EXPECTED_WAVE9).length,
  'wave 9 must extend the 34 reviewed note identities by exactly four source-backed identities'
);
