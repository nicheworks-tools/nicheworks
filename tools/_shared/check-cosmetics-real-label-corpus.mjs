...
// Wave 4 / PR29 quality floor. Keep the same source-backed products and improve
...
assert.ok(overallCoverage >= 0.90, `real-label exact coverage ${(overallCoverage * 100).toFixed(2)}% is below the 90% Wave 4 floor`);
