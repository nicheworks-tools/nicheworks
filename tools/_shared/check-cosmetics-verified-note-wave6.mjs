...
assert.equal(
  ...
  PRIOR_VERIFIED_NOTE_COUNT + Object.keys(EXPECTED_WAVE6).length,
  'wave 6 must extend the 22 reviewed note identities by exactly four source-backed identities'
);
