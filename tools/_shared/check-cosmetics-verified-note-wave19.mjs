...
assert.equal(
  ...
  PRIOR_VERIFIED_NOTE_COUNT + Object.keys(EXPECTED_WAVE19).length,
  'wave 19 must extend the 74 reviewed note identities by exactly four source-backed identities'
);
