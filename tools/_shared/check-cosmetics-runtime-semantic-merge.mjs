...
assert.equal(categoryConflicts.length, 22, 'the 4 legacy category conflicts plus 18 reviewed Wave 15-16 and Wave 18-21 legacy-vs-verified role conflicts must be explicit at runtime');
