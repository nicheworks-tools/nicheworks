...
assert.equal(
  ...
  PRIOR_VERIFIED_NOTE_COUNT + Object.keys(EXPECTED_WAVE7).length,
  'wave 7 must extend the 26 reviewed note identities by exactly four source-backed identities'
);
