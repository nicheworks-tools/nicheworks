...
assert.equal(
  ...
  PRIOR_VERIFIED_NOTE_COUNT + Object.keys(EXPECTED_WAVE12).length,
  'wave 12 must extend the 46 reviewed note identities by exactly four source-backed identities'
);
