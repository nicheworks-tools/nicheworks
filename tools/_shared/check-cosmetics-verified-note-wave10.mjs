...
assert.equal(
  ...
  PRIOR_VERIFIED_NOTE_COUNT + Object.keys(EXPECTED_WAVE10).length,
  'wave 10 must extend the 38 reviewed note identities by exactly four source-backed identities'
);
