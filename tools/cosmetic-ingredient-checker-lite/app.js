...
const CATEGORY_LABELS = {
  ...
  smoothing: { ja: '肌をなめらかに', en: 'Smoothing' },
  binder: { ja: '結合剤', en: 'Binder' },
...
const ROLE_DESCRIPTIONS = {
  ...
  smoothing: { ja: '肌表面の粗さや凹凸を減らし、なめらかに整える目的で使われる成分です。', en: 'Used to smooth the skin surface by reducing roughness or irregularities.' },
  binder: { ja: '粉末状の成分同士をまとめ、製品のまとまりを保つ目的で使われる成分です。', en: 'Used to bind powder ingredients together and help maintain product cohesion.' },
