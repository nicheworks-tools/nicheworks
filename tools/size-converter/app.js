(() => {
  ...
  const DATA = {
    shoes: {
      men: [
        { jp: "22.0", us: "4", eu: "36" },
        { jp: "22.5", us: "4.5", eu: "36.5" },
        { jp: "23.0", us: "5", eu: "37.5" },
        { jp: "23.5", us: "5.5", eu: "38" },
        { jp: "24.0", us: "6", eu: "39" },
        { jp: "24.5", us: "6.5", eu: "39.5" },
        { jp: "25.0", us: "7", eu: "40" },
        ...
        { jp: "29.0", us: "11", eu: "45" },
        { jp: "29.5", us: "11.5", eu: "45.5" },
        { jp: "30.0", us: "12", eu: "46" },
        { jp: "30.5", us: "12.5", eu: "47" },
        { jp: "31.0", us: "13", eu: "47.5" }
      ],
      women: [
        { jp: "21.0", us: "4", eu: "34" },
        { jp: "21.5", us: "4.5", eu: "34.5" },
        { jp: "22.0", us: "5", eu: "35" },
        ...
        { jp: "26.0", us: "9", eu: "40.5" },
        { jp: "26.5", us: "9.5", eu: "41" },
        { jp: "27.0", us: "10", eu: "42" },
        { jp: "27.5", us: "10.5", eu: "42.5" },
        { jp: "28.0", us: "11", eu: "43" },
        { jp: "28.5", us: "11.5", eu: "44" },
  ...
  const TEXT = {
    ja: {
      ...
      footError: "足長は18〜35cmの数値で入力してください。",
      widthError: "足幅は数値で入力してください。未入力でも使えます。",
      waistError: "ウエストを数値で入力してください。",
      optionalError: "任意項目は、入力する場合は数値にしてください。",
      fitTitle: "近いサイズ目安",
      nearby: "近い候補",
      ...
      widthNone: "足幅は任意です。入力すると幅の傾向を補足します。",
      amazonShoes: "Amazonでシューズを探す",
      amazonClothing: "Amazonで服を探す"
    },
    en: {
      approx: "General estimate",
      ...
      footError: "Enter foot length as a number from 18 to 35 cm.",
      widthError: "Foot width must be numeric. It can be left blank.",
      waistError: "Enter waist as a number.",
      optionalError: "Optional fields must be numeric when filled.",
      fitTitle: "Nearby size estimate",
      ...
      widthNone: "Foot width is optional. Add it for a rough width note.",
      amazonShoes: "Find shoes on Amazon",
      amazonClothing: "Find clothing on Amazon"
    }
  };
  ...
  const els = {
    ...
    tbody: $("sizeTableBody"),
    copyTable: $("copySizeTable"),
    shoeSection: $("shoeFitSection"),
    clothingSection: $("clothingFitSection"),
    footLength: $("footLength"),
    footWidth: $("footWidth"),
    shoeRun: $("shoeFitRun"),
    shoeReset: $("shoeFitReset"),
    shoeResult: $("shoeFitResult"),
    clothType: $("clothType"),
    clothUnit: $("clothUnit"),
    clothChest: $("clothChest"),
    clothWaist: $("clothWaist"),
    clothHip: $("clothHip"),
    clothRun: $("clothFitRun"),
    clothReset: $("clothFitReset"),
    clothResult: $("clothFitResult"),
    affiliate: $("sizeAffiliate"),
    disclosure: $("amazonDisclosure"),
  ...
  function rebuildSizeOptions() {
    ...
    if (previous && Number(previous) < current.length) els.size.value = previous;
    renderQuickResult();
    renderTable();
  }
  ...
  function selectedRow() {
    const current = rows();
    const index = Number(els.size.value || 0);
    return current[index] || current[0] || null;
  }
  ...
  function renderQuickResult() {
    ...
    if (!row) {
      els.quickResult.appendChild(make("p", "empty-note", t("noData")));
      return;
    }
  ...
  function renderTable() {
    ...
    rows().forEach((row) => {
      ...
      ["jp", "us", "eu"].forEach((system) => {
        const td = make("td", system === key ? "is-base" : "", row[system]);
        tr.appendChild(td);
      });
  ...
  function runShoeFit() {
    ...
    const nearTitle = make("p", "near-title", t("nearby"));
    card.appendChild(nearTitle);
  ...
  function mountAffiliate() {
    const helper = window.NWAmazonAffiliate;
    if (!helper) {
      if (els.affiliate) els.affiliate.hidden = true;
      return;
    }
