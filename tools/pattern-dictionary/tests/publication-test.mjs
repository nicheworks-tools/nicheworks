...
if(prod.patterns.length!==100)throw new Error(`expected 100 production patterns, got ${prod.patterns.length}`);
...
if(refs.status!=='verified-publication'||refs.images.length!==100)throw new Error('reference image publication set must contain verified 100');
...
if(detailCount!==200)throw new Error(`expected 200 detail pages, got ${detailCount}`);
