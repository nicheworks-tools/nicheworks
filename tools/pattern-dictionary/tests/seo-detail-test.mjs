...
if(ids.length!==60)throw new Error(`expected 60 published patterns, got ${ids.length}`);
...
console.log('OK: 120/120 JA+EN Pattern Dictionary detail pages carry canonical social, language, icon, and structured-data publication metadata.');
