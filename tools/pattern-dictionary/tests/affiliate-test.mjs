...
if(JSON.stringify(ids)!==JSON.stringify(patternOfferIds))throw new Error('affiliate offers must cover exactly the published 40 patterns');
...
if(offers.length<105)throw new Error(`40-pattern publication should materially expand the 65-link base; got only ${offers.length}`);
...
console.log(`OK: Pattern Dictionary exposes ${offers.length} maintained Amazon intent links across 40 published patterns, with no free-text forwarding.`);
