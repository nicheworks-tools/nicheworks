...
- Tool behavior and release contract: `tools/pattern-dictionary/SPEC.md` and canonical repository documentation at `docs/tools/pattern-dictionary.md`.
