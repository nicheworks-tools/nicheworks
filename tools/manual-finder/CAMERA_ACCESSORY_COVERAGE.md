...
| Camera records with verified accessory detail | **43** |
| Reviewed camera-detail exclusions | **0** |
| Actionable camera records still missing accessory detail | **142** |
...
The current detail ledger contains all 14 actionable Nikon records plus twenty-nine reviewed DJI records across Osmo Action Wave 1, Air Wave 2, Mini Wave 3, Mavic 3 Wave 4, Air 2S/Mavic Air 2 Wave 5, compact power Wave 6, Mini 2 Wave 7, FPV Wave 8, Avata Wave 9, Mavic 2 Wave 10, Mavic Mini Wave 11, Mavic Air Wave 12, Mavic Pro Wave 13, Mavic Pro Platinum Wave 14, and Mavic 3 Enterprise/Mavic 3M Wave 15.
...
The exact missing model arrays are emitted by `tests/camera-accessory-coverage.test.mjs` as `MANUALFINDER_CAMERA_ACCESSORY_COVERAGE`. They are intentionally not duplicated here as a 142-model prose ledger.
...
After DJI Waves 1–15 the maker-level reconciliation is:
...
1. Continue DJI from the remaining 67 actionable records in bounded product-family waves.
...
The current baseline is not complete: `142` actionable records remain missing accessory detail. Counts may change when the canonical catalog changes, but the reconciliation invariant and zero-unreviewed-missing completion target do not change.
