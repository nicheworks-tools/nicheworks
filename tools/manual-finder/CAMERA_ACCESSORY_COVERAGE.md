...
| Actionable camera records still missing accessory detail | **117** |
...
DJI coverage advances only through bounded exact-canonical-row waves backed by DJI official evidence. Waves 1–31 remain frozen in their reviewed ledgers.
...
After DJI Waves 1–32 the maker-level reconciliation is:
...
1. Continue DJI from the remaining 42 actionable records in bounded official-evidence waves.
...
The current baseline is not complete: `117` actionable records remain missing accessory detail.
