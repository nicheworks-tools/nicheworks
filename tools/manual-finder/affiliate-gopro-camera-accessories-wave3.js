(() => {
  ...
  const SOURCE = "https://gopro.com/en/us/shop/mounts-accessories/hero8-black-rechargeable-battery/AJBAT-001.html";
  const MODELS = Object.freeze(["HERO5 Black","HERO6 Black","HERO7 Black","HERO8 Black","HERO 2018"]);
  const rows = Object.freeze(MODELS.map((model) => Object.freeze({
    ...
    accessories: Object.freeze([Object.freeze({
      key: `gopro-wave3-battery-${model.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")}`,
      kind: "camera_battery_search", query: "GoPro HERO8 Black Rechargeable Battery",
      labelJa: "Amazonで GoPro HERO8 Black Rechargeable Battery を探す", labelEn: "Find GoPro HERO8 Black Rechargeable Battery on Amazon", sourceUrl: SOURCE
    })])
  })));
