(() => {
  ...
  const BATTERY_SOURCE = "https://store.dji.com/product/mavic-air-2-intelligent-flight-battery";
  const HUB_SOURCE = "https://store.dji.com/uk/product/mavic-air-2-battery-charging-hub";
  ...
  const makeRow = (model) => Object.freeze({
    ...
    accessories: Object.freeze([
      accessory(
        ...
        "Amazonで DJI Mavic Air 2 Intelligent Flight Battery を探す",
        "Find DJI Mavic Air 2 Intelligent Flight Battery on Amazon",
        BATTERY_SOURCE
      ),
      accessory(
        ...
        "Amazonで DJI Mavic Air 2 Battery Charging Hub を探す",
        "Find DJI Mavic Air 2 Battery Charging Hub on Amazon",
        HUB_SOURCE
      )
    ])
  });
  ...
  function getWave5Offers({ maker, model, category } = {}) {
