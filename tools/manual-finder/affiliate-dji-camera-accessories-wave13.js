(() => {
    ...
    Object.freeze({
      ...
      accessories: Object.freeze([
        accessory(
          ...
          "Mavic Pro Intelligent Flight Battery",
          "Amazonで Mavic Pro Intelligent Flight Battery を探す",
          "Find Mavic Pro Intelligent Flight Battery on Amazon",
          BATTERY_SOURCE
        ),
        accessory(
  ...
  function getWave13Offers({ maker, model, category } = {}) {
