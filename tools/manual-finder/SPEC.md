...
- The current camera state is **185 basic = 26 detail + 0 reviewed exclusions + 159 missing accessory detail** across 192 canonical camera-category records; 7 maker/index rows are non-actionable and excluded from the actionable denominator.
...
- DJI Mavic 3 Wave 4 maps all three reviewed consumer records to `DJI Mavic 3 Series Intelligent Flight Battery` and `DJI Mavic 3 Series Battery Charging Hub` from explicit DJI Store compatibility evidence.
...
- The measured DJI state after Waves 1–4 is **96 basic = 12 detail + 0 reviewed exclusions + 84 missing accessory detail**.
...
- The measured remaining camera backlog is DJI 84, OM SYSTEM 37, GoPro 31, and Insta360 7. Exact missing models are emitted by `tests/camera-accessory-coverage.test.mjs` and summarized by `CAMERA_ACCESSORY_COVERAGE.md`.
...
- [x] DJI Mavic 3 Wave 4 activates exactly `DJI Mavic 3`, `DJI Mavic 3 Classic`, and `DJI Mavic 3 Pro`, with exactly two DJI-backed power-accessory handoffs per model and no inference to Enterprise/3M/Cine or older Mavic records.
- [x] DJI Waves 1–4 reconcile to **96 basic = 12 detail + 0 reviewed exclusions + 84 missing accessory detail**.
- [x] The catalog-wide camera audit reconciles to **185 basic = 26 detail + 0 reviewed exclusions + 159 missing accessory detail**, while seven maker/index rows remain explicitly non-actionable.
