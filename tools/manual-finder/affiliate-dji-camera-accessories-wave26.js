(() => {
  ...
  const MODEL_SOURCE = "https://www.dji.com/downloads/products/phantom3-4k";
  ...
  const rows = Object.freeze([
    Object.freeze({
      ...
      accessories: Object.freeze([
        Object.freeze({
          key: "dji-phantom-3-intelligent-flight-battery-phantom-3-4k",
  ...
  function getWave26Offers({ maker, model, category } = {}) {
    ...
    if (cleanMaker !== "DJI" || cleanCategory !== "カメラ・映像" || cleanModel !== "Phantom 3 4K") return [];
