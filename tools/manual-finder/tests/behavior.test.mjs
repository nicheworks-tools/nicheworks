await import('./coverage-pass-pipeline.test.mjs');
await import('./sony-emount-coverage-pass-publication.test.mjs');
...
await import('./gopro-hero13-accessory-wave1.test.mjs');
