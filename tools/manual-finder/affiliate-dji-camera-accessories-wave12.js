(() => {
  ...
  const BATTERY_SOURCE = "https://repair.dji.com/help/content?customId=01700006548&lang=en&spaceId=17";
    ...
    Object.freeze({
      ...
      accessories: Object.freeze([
        accessory(
          ...
          "Mavic Air Intelligent Flight Battery",
          "Amazonで Mavic Air Intelligent Flight Battery を探す",
          "Find Mavic Air Intelligent Flight Battery on Amazon",
          BATTERY_SOURCE
        ),
        accessory(
          ...
          "Mavic Air Battery Charging Hub",
          "Amazonで Mavic Air Battery Charging Hub を探す",
          "Find Mavic Air Battery Charging Hub on Amazon",
          HUB_SOURCE
        )
      ])
    })
  ...
  function getWave12Offers({ maker, model, category } = {}) {
