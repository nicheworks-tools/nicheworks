(() => {
  ...
  const PRODUCT_SOURCE = "https://www.dji.com/downloads/products/spark";
  const BATTERY_SOURCE = "https://repair.dji.com/help/content?customId=01700009975&lang=en&paperDocType=ARTICLE&re=US&spaceId=17";
  const HUB_SOURCE = PRODUCT_SOURCE;
  ...
  const rows = Object.freeze([
    Object.freeze({
      ...
      evidenceUrls: Object.freeze([PRODUCT_SOURCE, BATTERY_SOURCE]),
      accessories: Object.freeze([
        accessory(
          "dji-spark-intelligent-flight-battery",
          "camera_battery_search",
          "DJI Spark Intelligent Flight Battery",
          "Amazonで DJI Spark Intelligent Flight Battery を探す",
          "Find DJI Spark Intelligent Flight Battery on Amazon",
          BATTERY_SOURCE
        ),
        accessory(
          ...
          "DJI Spark Battery Charging Hub",
          "Amazonで DJI Spark Battery Charging Hub を探す",
          "Find DJI Spark Battery Charging Hub on Amazon",
          HUB_SOURCE
        )
      ])
    })
  ...
  function getWave20Offers({ maker, model, category } = {}) {
