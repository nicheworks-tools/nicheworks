(() => {
  ...
  const MODELS = Object.freeze(["E-M1","E-M5","E-M5 Mark II","E-P5","PEN-F"]);
  ...
  const rows = Object.freeze(MODELS.map((model) => Object.freeze({
    ...
    accessories: Object.freeze([
      Object.freeze({
        key: `om-system-bln-1-${model.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "")}`,
        kind: "camera_battery_search",
        query: "OM SYSTEM BLN-1 Lithium Ion Rechargeable Battery",
        labelJa: "Amazonで OM SYSTEM BLN-1 バッテリーを探す",
        labelEn: "Find OM SYSTEM BLN-1 battery on Amazon",
        sourceUrl: SOURCE
      })
    ])
  })));
  ...
  window.MANUALFINDER_OM_SYSTEM_CAMERA_ACCESSORY_WAVE5_LEDGER = rows;
