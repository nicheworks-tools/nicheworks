(() => {
  ...
  const SOURCE = "https://gopro.com/en/us/shop/mounts-accessories/enduro-battery/AEBAT-001.html";
  const MODELS = Object.freeze(["HERO13 Black"]);
  const rows = Object.freeze(MODELS.map((model) => Object.freeze({
    ...
    accessories: Object.freeze([Object.freeze({
      key: `gopro-wave2-battery-${model.toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-|-$/g,"")}`,
      kind: "camera_battery_search", query: "GoPro Enduro Battery HERO13 Black",
      labelJa: "Amazonで GoPro Enduro Battery HERO13 Black を探す", labelEn: "Find GoPro Enduro Battery HERO13 Black on Amazon", sourceUrl: SOURCE
    })])
  })));
