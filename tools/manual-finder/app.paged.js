(() => {
  ...
  const WAVE2 = `${base}/data/manuals.wave2.js?v=mf-wave2a-20260912a`;
  const JSON_URL = `${base}/data/manuals.json?v=mf-wave2a-20260912a`;
  ...
  async function loadWave2() {
    try {
      ...
      await Promise.all(batches.map((name) => loadScript(`${base}/data/${name}?v=mf-wave2a-20260912a`)));
