...
- browser result intake file: exists (`tools/earth-map-suite/ems-rd-11-browser-self-check-result.json`) as placeholder until actual browser JSON is pasted.
- current branch_decision: `browser_result_missing`.

Storm real remains blocked unless all of the following are true:
