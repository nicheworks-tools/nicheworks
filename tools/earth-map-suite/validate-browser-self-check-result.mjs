...
const ALLOWED_MODES=new Set(['safe_self_health_manifest','research_probe','not_run']);
...
for(const f of ['branch_decision','public_real_data_enabled','storm_compare_card_connected','endpoints','mode','page_url','checked_at']) if(!Object.hasOwn(parsed,f)) fail(`Missing required top-level field: ${f}`);
