(() => {
  ...
  const I18N = {
    ja: {
      ...
      timelineTitle: "引っ越しでやることの時系列",
      timelineIntro: "このツールは、引っ越し全体を「いつ何をやるか」で整理します。日付を入れる前でも、主な流れは次の順序です。",
      timeline30: "30日前：引越し業者の見積もり、退去連絡、ネット回線、不用品整理を始める。",
      timeline14: "14日前：住所変更先の洗い出し、郵便転送、役所手続きの必要書類、粗大ごみ予約を確認する。",
      timeline7: "7日前：引越し業者とライフラインを最終確認し、箱ラベルや荷造りのルールを固める。",
      timeline3: "3日前：当日持ち出し袋、掃除道具、搬出入経路、駐車場所を確認する。",
      timeline1: "前日：冷蔵庫、鍵・契約書・重要書類、旧居・新居の写真記録などを確認する。",
      timelineDay: "当日：忘れ物、メーター、旧居・新居の設備、搬入後の傷などを確認する。",
      timelineAfter: "引越し後：転入届、マイナンバー、免許証、銀行・カード・保険・携帯などの住所変更を進める。",
      timelineBoundary: "退去立会い・鍵返却・メーター写真・原状回復など「退去直前だけ」を詳しく確認したい場合は、専用の Moving / Lease Final Check を使ってください。",
      usageLink: "使い方はこちら",
      movingDate: "引っ越し日",
      household: "家族構成",
      solo: "単身",
    ...
    en: {
      ...
      timelineTitle: "Moving timeline: what to do and when",
      timelineIntro: "This tool organizes the whole move by timing. Even before you enter a date, the main sequence is:",
      timeline30: "30 days before: compare movers, give move-out notice, check internet service, and start sorting unwanted items.",
      timeline14: "14 days before: list address changes, prepare mail forwarding, check municipal documents, and book bulky-waste pickup.",
      timeline7: "7 days before: reconfirm movers and utilities, then finalize box-label and packing rules.",
      timeline3: "3 days before: prepare an essentials bag, keep cleaning tools accessible, and confirm routes and parking.",
      timeline1: "Day before: check the refrigerator, keys/contracts/documents, and photo records of the old and new home.",
      timelineDay: "Moving day: check belongings, meters, utilities, and any damage after moving in.",
      timelineAfter: "After the move: complete move-in notification and update IDs, banks, cards, insurance, and mobile services.",
      timelineBoundary: "For detailed move-out-only checks such as inspection, key return, meter photos, and restoration notes, use the dedicated Moving / Lease Final Check.",
