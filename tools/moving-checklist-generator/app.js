(() => {
  ...
  const I18N = {
    ja: {
      ...
      hint: "保存されるのはチェック状態のみです。別端末・別ブラウザには引き継がれず、ブラウザデータを削除すると消えます。",
      ...
      faqA1: "このブラウザのlocalStorageに保存されます。別端末や別ブラウザには引き継がれません。",
      faqQ2: "PDFとして保存できますか？",
      ...
      faqA4: "ありません。印刷用メモも任意です。個人情報は入力しないことを推奨します。",
    ...
    en: {
      ...
      hint: "Only check states are saved. They do not sync across devices or browsers, and may be cleared if you delete browser data.",
      ...
      faqA1: "They are saved in this browser using localStorage. They do not sync to another device or browser.",
      ...
      faqA4: "No. The print note is optional, and we recommend avoiding personal information.",
      metaLine: ({dateStr, household, homeType}) => `${dateStr} / ${household} / ${homeType}`,
