...
// 63. Pages Deploy Guide — all checklist, diagnosis, handoff, copy, and Markdown outputs are free and local.
has('tools/pages-deploy-guide/app.js', 'function platformItems(s)');
has('tools/pages-deploy-guide/app.js', 'copyAll');
has('tools/pages-deploy-guide/app.js', 'diagnosisText');
has('tools/pages-deploy-guide/app.js', 'downloadMd');
has('tools/pages-deploy-guide/app.js', 'text/markdown;charset=utf-8');
lacks('tools/pages-deploy-guide/app.js', 'pdg_pro_key', 'legacy local Pro key');
lacks('tools/pages-deploy-guide/app.js', 'NW-PDG-', 'legacy Pro code');
lacks('tools/pages-deploy-guide/index.html', '/assets/nw-pro.js', 'shared Pro runtime');
lacks('tools/pages-deploy-guide/index.html', 'buy.stripe.com', 'retired Pro purchase link');
lacks('tools/pages-deploy-guide/index.html', 'Pages Deploy Guide Pro', 'retired Pro surface');
check(!exists('tools/pages-deploy-guide/pro-bridge.js'), 'tools/pages-deploy-guide/pro-bridge.js: retired Pro bridge must be removed');
has('tools/pages-deploy-guide/SPEC.md', 'All current outputs are free');
has('tools/pages-deploy-guide/SPEC.md', 'Amazon affiliate monetization is not part of the current product contract');
