...
check(contract.includes('Amazon is an **active cluster revenue surface on all eight Old Kanji tools**'), 'all-eight active Amazon boundary missing');
check(contract.includes('fixed curated searches') && contract.includes('user-derived values'), 'Amazon contextual/privacy boundary missing');
