...
This record is the canonical per-tool contract for the registered `phone-quickcheck` implementation at `/tools/phone-quickcheck/`. The maintained public dataset contains 168 smartphone records across Apple, Google, Samsung, Sony, SHARP, OPPO, Xiaomi, and Motorola.
...
- 168機種の検証済みデータをブラウザ内で検索・絞り込み・並び替えする。
...
- [x] 168 maintained models load from the static phone dataset.
