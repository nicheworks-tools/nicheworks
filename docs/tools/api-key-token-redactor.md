...
Automated test evidence: `tools/api-key-token-redactor/tests/.gitignore`, `tools/api-key-token-redactor/tests/EXPECTED.json`, `tools/api-key-token-redactor/tests/README.md`, `tools/api-key-token-redactor/tests/generate_testdata.js`.
