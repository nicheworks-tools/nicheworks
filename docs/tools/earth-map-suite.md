...
Automated test evidence: `tools/earth-map-suite/EMS_RD_05_DEPLOYED_PROBE_CHECK.md`, `tools/earth-map-suite/EMS_RD_05_STORM_REAL_PRECHECK.md`, `tools/earth-map-suite/EMS_RD_10_BROWSER_SELF_CHECK.md`, `tools/earth-map-suite/EMS_RD_14_SELF_CHECK_ENDPOINT.md`, `tools/earth-map-suite/EMS_RD_16_SAFE_CHECK_RESULT.md`, `tools/earth-map-suite/ems-rd-11-browser-self-check-result.json`, `tools/earth-map-suite/ems-rd-11-browser-self-check-result.template.json`, `tools/earth-map-suite/validate-browser-self-check-result.mjs`.
