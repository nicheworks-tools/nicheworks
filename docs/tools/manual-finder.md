...
- **Runtime evidence inspected:** `tools/manual-finder/app.curated.js`, `tools/manual-finder/app.js`, `tools/manual-finder/app.paged.js`, `tools/manual-finder/en/index.html`, `tools/manual-finder/howto/en/index.html`, `tools/manual-finder/howto/howto/index.html`, `tools/manual-finder/howto/index.html`, `tools/manual-finder/index.html`.
...
- **Usage documentation:** `recommended-and-present`. Evidence: `tools/manual-finder/usage-en.html`, `tools/manual-finder/usage.html`. Missing recommended documentation is an improvement opportunity, not a hard compliance failure.
