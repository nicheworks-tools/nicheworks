...
Automated test evidence: `tools/trashnavi/scripts/audit-coverage.mjs`, `tools/trashnavi/scripts/generate-municipality-pages.mjs`, `scripts/check-trashnavi-direct-links.mjs`, `scripts/update-trashnavi-localgovjp.mjs`, `scripts/validate-trashnavi-data.mjs`.
