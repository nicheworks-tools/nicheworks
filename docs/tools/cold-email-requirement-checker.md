...
- **Runtime evidence inspected:** `tools/cold-email-requirement-checker/app.js`, `tools/cold-email-requirement-checker/howto/en/index.html`, `tools/cold-email-requirement-checker/howto/index.html`, `tools/cold-email-requirement-checker/index.html`.
