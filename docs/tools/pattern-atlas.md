...
- **Runtime evidence inspected:** `tools/pattern-atlas/index.html`, `tools/pattern-atlas/ja/index.html`, `tools/pattern-atlas/js/app.js`, `tools/pattern-atlas/mock-html/index.html`.
