...
Automated test evidence: `tools/construction-tools-atlas/design-spec.md`, `tools/construction-tools-atlas/images/pilot/vertical-line-check.svg`, `tools/construction-tools-atlas/scripts/audit-duplicates.mjs`, `tools/construction-tools-atlas/scripts/dedupe-quality-data.mjs`, `tools/construction-tools-atlas/scripts/merge-pack-001.mjs`, `tools/construction-tools-atlas/scripts/tsv-to-pack.mjs`, `tools/construction-tools-atlas/scripts/validate-data.mjs`, `tools/construction-tools-atlas/spec.md`.
