...
- **Runtime evidence inspected:** `tools/rename-wizard/app.js`, `tools/rename-wizard/en/index.html`, `tools/rename-wizard/howto/en/index.html`, `tools/rename-wizard/howto/index.html`, `tools/rename-wizard/index.html`.
